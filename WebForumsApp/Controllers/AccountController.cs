...
namespace WebForumsApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LoginWith2fa(bool rememberMe, string returnUrl = null)
        {
            ...
            var model = new LoginWith2faVM { RememberMe = rememberMe };
            ViewData["ReturnUrl"] = returnUrl;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> LoginWithRecoveryCode(LoginWithRecoveryCodeVM model, string returnUrl = null)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        public async Task<IActionResult> Register(RegisterVM model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Username, Email = model.Email, JoinedOn = DateTime.Now, IsActive = true };
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                return View("ExternalLogin", new ExternalLoginVM { Email = email });
            }
        }
